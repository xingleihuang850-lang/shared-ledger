...
- **Android APK（Android 6.0 及以上）**：[直接下载共享账本 v1.2.3 APK](https://github.com/xingleihuang850-lang/shared-ledger/releases/download/v1.2.3/shared-ledger-android-v1.2.3.apk)。下载后直接打开 `.apk` 文件，按系统提示安装；首次安装时可能需要允许当前浏览器或文件管理器“安装未知应用”。安装后桌面显示“账本”图标，首次打开请联网。ZIP 文件用于网页部署与源码查看。
...
配置自动发布后，推送形如 `v1.2.3` 的版本标签，GitHub Actions 会自动：
